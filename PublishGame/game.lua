...
-- START:requires
-- Load the advertising file
require( "advertising" )
-- Load the in-app purchases file
require( "purchasing" )
-- END:requires
...
function scene:createScene( event )
    ...
    -- START:loadBackground
    -- Load the background image
    backgroundImg = display.newImage( "images/background.jpg" )
	backgroundImg.anchorX, backgroundImg.anchorY = 0, 0
...
function scene:enterScene( event )
    ...
    -- START:callAdFunction
    -- Call the ads
    -- Uncomment the function depending on the ad service you use
    showInMobiAds( )
    -- showInneractiveAds( )
    -- END:callAdFunction
end
